...
The exact options may change in later versions. For v0.1.0 the main commands are: \
<br>
`runpilot run`
...
Check runpilot run `--help` for the exact flags in your build.
---
`runpilot list`
List previous runs.
...
`runpilot show`
Show metadata for a single run.
